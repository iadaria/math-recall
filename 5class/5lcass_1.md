...
Прямые AB и PQ имеют одну общую точку М. Говорят, что прямые AB и PQ `пересекаются` в этой точке.

### Луч
![Луч](./imgs/line_1_4_3.png)\
Проведем прямую LN и отметим на ней точку O. Эта точка разделить прямую на две части, каждую из которых называют `лучом`.\
А точку O называют `началом этих лучей`. Конца у луча нет.\
На рисунке два луча: луч OL и луч ON. При обозначении луча на первое место всегда ставят начало, а на второе - какую-нибудь из точек этого луча.\
Лучи OL и ON называют `дополнительными` друг другу.

![Точки и лучи](./imgs/line_1_4_4.png)\
Точка P `лежит` на луче OF, а точка A и K `не лежат` на нем.

### Угол
![Угол](./imgs/line_1_4_5.png)\
__Углом__ называют фигуру, которая состоит из точки - вершины угла - и двух различных лучей, исходящих из этой точки, - сторон угла.\
Лучи BA, BC - стороны угла, точка В - вершина угла. Угол из рисунка можно обозначить тремя способами:
![Углы](./imgs/angle.png)\
Букву, обозначающую вершину угла, всегда пишут в середине обозначения.

### Задачи 1.4

1.луч PN и прямая XZ не пересекаются из-за начала луча и продолжения в другую сторону.\
![Пересечение](./imgs/line_task_1_93_b.png)\
